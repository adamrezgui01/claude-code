...
export const fr = {
  commun: {
    ...
    periodeSuivante: 'Période suivante',
    diminuer: 'Diminuer',
    augmenter: 'Augmenter',
    ...
    du: 'Du',
    au: 'Au',
    voirLes_one: 'Voir le {{count}}',
    voirLes_other: 'Voir les {{count}}',
    reduire: 'Réduire',
  ...
  dose: {
    ...
    avis: 'L’outil fait l’arithmétique, pas le jugement clinique.',
    patient: 'Patient',
    poids: 'Poids',
    poidsPlaceholder: '18',
    kg: 'kg',
    lb: 'lb',
    enLivres: 'soit {{valeur}} lb',
    enKilos: 'soit {{valeur}} kg',
    posologie: 'Posologie',
    dose: 'Dose',
    doseAide: 'Celle que vous avez vérifiée. L’application n’en propose aucune.',
    parJour: 'mg/kg/jour',
    parPrise: 'mg/kg/dose',
    ...
    maximum: 'Dose maximale quotidienne (mg)',
    incomplet: 'Poids, dose et concentration : les trois sont nécessaires.',
    etapeQuotidienne: '{{poids}} kg × {{dose}}',
    etapePrise: '÷ {{prises}} prises',
    etapeVolume: 'dose par prise ÷ concentration',
    etapeBouteilles: '÷ {{format}} mL',
    mgParJour: '{{valeur}} mg par jour',
    mgParPrise: '{{valeur}} mg par prise',
    mgParMl: '{{valeur}} mg/mL',
    mlParPrise: '{{valeur}} mL par prise',
    mlTotal: '{{valeur}} mL',
    exact: 'exact : {{valeur}} mL',
    aServir: 'À servir',
    bouteilles_one: '{{count}} bouteille',
    ...
    nomRaccourci: 'Nom du raccourci',
    nomRaccourciPlaceholder: 'Amox 90',
    supprimerRaccourci: 'Supprimer ce raccourci ?',
  },
