...
export const en: Dictionnaire = {
  commun: {
    ...
    du: 'From',
    au: 'To',
    voirLes_one: 'Show the {{count}}',
    voirLes_other: 'Show all {{count}}',
    reduire: 'Collapse',
  ...
  quart: {
    ...
    creerEntendue: 'Create {{nom}}',
    creerEntendueAide:
      'This pharmacy is not in your directory. Its record opens with that name; everything else you dictated is waiting here.',
  ...
  dose: {
    titre: 'Dose calculator',
    avis: 'The tool does the arithmetic, not the clinical judgement.',
    patient: 'Patient',
    poids: 'Weight',
    poidsPlaceholder: '18',
    kg: 'kg',
    lb: 'lb',
    enLivres: 'that is {{valeur}} lb',
    enKilos: 'that is {{valeur}} kg',
    posologie: 'Dosing',
    dose: 'Dose',
    doseAide: 'The one you checked. The app never suggests one.',
    parJour: 'mg/kg/day',
    parPrise: 'mg/kg/dose',
    ...
    ml: 'mL',
    facultatif: 'Optional',
    duree: 'Treatment length (days)',
    format: 'Bottle size (mL)',
    maximum: 'Maximum daily dose (mg)',
    incomplet: 'Weight, dose and concentration: all three are needed.',
    etapeQuotidienne: '{{poids}} kg × {{dose}}',
    etapePrise: '÷ {{prises}} doses',
    etapeVolume: 'dose per intake ÷ concentration',
    etapeBouteilles: '÷ {{format}} mL',
    mgParJour: '{{valeur}} mg per day',
    mgParPrise: '{{valeur}} mg per dose',
    mgParMl: '{{valeur}} mg/mL',
    mlParPrise: '{{valeur}} mL per dose',
    mlTotal: '{{valeur}} mL',
    exact: 'exact: {{valeur}} mL',
    aServir: 'To dispense',
    bouteilles_one: '{{count}} bottle',
    ...
    nomRaccourci: 'Shortcut name',
    nomRaccourciPlaceholder: 'Amox 90',
    supprimerRaccourci: 'Delete this shortcut?',
  },
  ...
  rendezVous: {
    ...
    detail:
      'One notification a day, in the evening, and only if there is something to do: a shift tomorrow, hours to confirm, a document nearing expiry, an unpaid invoice, notes to review.',
    heure: 'At what time?',
  },

  notifications: {
    veilleTitre: 'Clinical review',
    titreDocument: 'Document to renew',
    titreQuart: 'Shift tomorrow',
    titreFacture: 'Invoice still unpaid',
    titreMemo: 'Did your hours change?',
    ligneVeille: 'To review: {{nom}}',
    ligneSources: 'A source to re-check',
    ligneDocument: '{{nom}} is nearing its expiry',
    ligneQuart: 'Tomorrow: {{nom}}',
    ligneFacture: 'Still unpaid: {{nom}}',
    ligneMemo: 'Hours to confirm: {{nom}}',
    etDautres: 'And more, in the app.',
  ...
  disponibilites: {
    ...
    deHeure: 'from',
    aHeure: 'to',
    finAvantDebut: 'The end must come after the start. Availability does not cross midnight.',
